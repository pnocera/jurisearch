...
- Remaining for later 1.1 slices: use persisted `TEXTELR` metadata for broader text-structure assembly across article versions, expand status/temporal fixtures across the full LEGI corpus, and publish coverage/freshness manifest fields.
