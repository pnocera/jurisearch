...
- Remaining for later 1.1 slices: use persisted `TEXTELR` metadata for broader text-structure and multi-link hierarchy assembly across article versions, and add maintenance batching for full hierarchy rebuilds if corpus-scale runs require it.
