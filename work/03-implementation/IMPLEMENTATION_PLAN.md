...
- Remaining: promote release-gating fixtures only after named human legal-domain review, and decide whether the current release-gating fixture set is strong enough to prove hybrid over BM25 (the current four fixtures do not, because BM25 and hybrid both pass).
