...
- Remaining before 0.5 is complete: add `SECTION_TA`/`TEXTELR` or document why they are deferred from Phase 0, emit structural chunks with block-boundary handling, and re-verify required fields against the current official DTDs.
