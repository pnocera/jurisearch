...
- Remaining for later 1.1 slices: use persisted `TEXTELR`/`SECTION_TA` metadata to assemble full hierarchy paths across article versions, expand status/temporal fixtures across the full LEGI corpus, and publish coverage/freshness manifest fields.
