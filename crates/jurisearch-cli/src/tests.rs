//! Unit tests for the CLI binary (phase gates, citation/date/archive helpers,
//! session contract parity, benchmark-artifact validators, help coverage). Moved out of
//! main.rs verbatim; `use super::*` resolves the crate-root re-exports.
