...
use jurisearch_storage::{
    retrieval::{
        CitationResolutionQuery, ContextDocumentsQuery, FetchDocumentsQuery, GroupBy, HybridCandidateQuery, RetrievalOptions,
...
fn migrated_schema_supports_bm25_and_vector_candidate_retrieval() -> Result<(), StorageError> {
    ...
    let second_article_page = hybrid_candidates_json(
        ...
        &HybridCandidateQuery {
            ...
            options: RetrievalOptions::default(),
            group_by: GroupBy::Chunk,
            after_cursor: Some(RetrievalCursor::Chunk {
                score: cursor_score,
